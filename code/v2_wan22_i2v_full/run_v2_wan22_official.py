#!/usr/bin/env python3
"""Run all V2 Wan2.2 I2V jobs through the official Wan2.2 generate.py."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--frame-num", type=int, default=121, help="Wan expects 4n+1. Use 81 for smoke, 121 for longer V2 clips.")
